...
* Pathwasy Level 2の条件を満たしていないが、エリアコンテストに参加できるか？　→　出場者の適格性を満たさないため、その方は用紙にサインできないと思います。サインできないならば、出場はできませんね。お勧めとしては、他クラブに参加させてもらい、コンテストまでにLevel 2の要件を満たすべく努力することですかねー。
